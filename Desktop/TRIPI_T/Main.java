...
public class Main {
    public static  void main(String[] args) throws ParseException {
        ...
        String message5= "give me the latitude of "+ response4 +" with no introduction , no explanation just a number";
        String latitude = GPT.chatGPT(message5);
        response4 ="give me the longtitude of"+response4+ "with no introduction , no explanation just a number";
        String longtitude = GPT.chatGPT(message5);
