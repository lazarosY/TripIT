...
public class GPT2 {
    ...
    public static String chatGPT2(String message) {
        ...
        try {
            ...
            con.setRequestProperty("Content-Type", "application/json");// json: a file that stores data stractures in
                                                                       // java script (in text form) in a way that is
                                                                       // readable for the everyday man that's used to
            ...
            // HTTP RESPONSE
            BufferedReader gptin = new BufferedReader(new InputStreamReader(con.getInputStream()));// returns an input
                                                                                                   // from the
                                                                                                   // connection to the
                                                                                                   // url
            String gptinputLine;
